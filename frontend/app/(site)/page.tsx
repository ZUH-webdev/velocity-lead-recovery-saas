  ...
  return (
    ...
    >
      <div className="flex items-center mt-[20px] justify-between">
        <span className="font-mono-ui text-[12px] font-[400] uppercase tracking-[0.08em] text-[#6b7280]">
          Live Feed
        </span>
      ...
      <motion.div className="mt-[20px] space-y-[20px]" variants={listVariant}>
        {feedRows.map((row) => (
          ...
          >
            ...
            <span
              className={`font-mono-ui text-[12px] font-[500] tracking-[0.04em] ${row.tone} text-right`}
            >
              {row.status}
            </span>
          </motion.div>
      ...
      <div className="mt-[42px] flex items-center justify-between border-t border-transparent pt-[6px]">
        ...
        <span className="font-mono-ui text-[12px] font-[500] tracking-[0.04em] text-[#111827]">
          98.2%
        </span>
      </div>
    </motion.div>
...
function HeroSection() {
  return (
    <section
      ...
      className="mx-auto flex flex-col md:flex-row max-w-[1440px] justify-between gap-[40px] md:gap-[32px] lg:gap-[72px] px-[24px] md:px-[40px] lg:px-[80px] pt-[36px] mt-9"
    >
      <ScrollRevealGroup
        className="w-full max-w-[640px] pt-[12px]"
        direction="left"
        stagger={0.1}
        delayChildren={0.04}
        hero={true}
      >
        <ScrollRevealItem
          className="inline-flex h-[31px] items-center gap-[9px] rounded-full border border-[#e6eaef] bg-white px-[14px] font-mono-ui text-[11px] font-[400] uppercase tracking-[0.1em] text-[#678096] shadow-[0_1px_0_rgba(15,23,42,0.02)]"
          direction="left"
          hero={true}
        >
        ...
        <ScrollRevealItem
          className="mt-[30px] max-w-[620px]"
          direction="left"
          hero={true}
        >
          <p className="font-body text-[18px] font-[400] leading-[1.65] text-[#4b5563]">
            Velocity is the intelligence that runs while you focus on care. It works in
            the margins to recover what was already yours.
          </p>
        </ScrollRevealItem>

        <ScrollRevealItem
          className="mt-[40px] flex flex-col md:flex-row items-stretch md:items-center gap-[12px] md:gap-[16px]"
          direction="left"
          hero={true}
        >
          <Link
        ...
        <ScrollRevealItem
          className="mt-[73px] flex items-center gap-[18px] font-mono-ui text-[11px] font-[400] uppercase tracking-[0.1em] text-[#6b7280]"
          direction="left"
          hero={true}
        >
      ...
      <ScrollRevealItem
        className="mt-[40px] w-full max-w-[445px]"
        direction="right"
        hero={true}
      >
        <HeroCard />
...
function StatSection() {
  ...
  return (
    <section className="w-full bg-white">
      <ScrollRevealGroup
        className="mx-auto max-w-[1440px] px-[24px] md:px-[40px] lg:px-[80px] py-[60px]"
        stagger={0.12}
      >
          ...
          >
            ...
            <ScrollRevealItem direction="left">
              <p className="font-body text-[17px] font-[400] leading-[1.7] text-[#374151] mb-[32px]">
                When a call drops, Velocity initiates a hyper-realistic AI voice protocol
                within 45 seconds. It sounds human, acts clinical, and books immediately.
              </p>
            </ScrollRevealItem>
            ...
            <ScrollRevealItem direction="left" className="flex flex-col gap-[12px]">
              <div className="flex items-center gap-[12px]">
                ...
                <span className="font-body text-[15px] font-[400] text-[#374151]">
                  Zero latency response protocols.
                </span>
              </div>
              ...
              <div className="flex items-center gap-[12px]">
                <Check className="h-[16px] w-[16px] text-[#b5895a]" />
                <span className="font-body text-[15px] font-[400] text-[#374151]">
                  Practice-specific persona mapping.
                </span>
              </div>
              ...
              <div className="flex items-center gap-[12px]">
                <Check className="h-[16px] w-[16px] text-[#b5895a]" />
                <span className="font-body text-[15px] font-[400] text-[#374151]">
                  Full compliance with healthcare recording laws.
                </span>
              </div>
            </ScrollRevealItem>
          </ScrollRevealGroup>
          ...
          <ScrollRevealItem className="w-full md:w-[55%]" direction="right">
            <div className="bg-white border border-[#e5e7eb] rounded-[12px] p-[28px] shadow-[0_2px_16px_rgba(0,0,0,0.05)] max-w-full">
              <div className="flex items-center gap-[14px] mb-[28px]">
                ...
                <div>
                  <div className="font-body text-[15px] font-[600] text-[#0f0f10]">
                    Inbound Call Missed
                  </div>
              ...
              <div className="flex flex-col gap-[14px] font-mono-ui text-[13px] leading-[1.5]">
                <div className="text-[#9ca3af]">
                  00:00:45 &gt; INITIATE OUTBOUND SEQUENCE
                </div>
                <div className="text-[#9ca3af]">00:00:48 &gt; CONNECTION ESTABLISHED</div>

                <div className="text-[#96510c] font-[400]">
                  "Hi, this is Sarah from Dr. Miller's office. I saw we just missed your
                  call. Are you looking to schedule an appointment?"
                </div>

                <div
                  style={{ borderLeft: '3px solid #e5e7eb' }}
                  className="pl-[12px] text-[#6b7280]"
                >
                  "Yes, I was hoping to get in this week."
                </div>

                <div className="text-[#9ca3af]">
                  00:01:12 &gt; INTENT_CONFIRMED : SCHEDULING
                </div>
              </div>
            </div>
          </ScrollRevealItem>
        ...
        >
          <ScrollRevealItem className="mx-auto mb-[32px]" direction="up">
            <h3 className="font-hero text-[clamp(26px,5vw,52px)] font-[500] leading-[1.2] tracking-[-0.02em] text-[#0f0f10]">
              The silence of a missed call isn't an operational flaw. It's a clinical
              failure disguised as a busy day.
            </h3>
          </ScrollRevealItem>

          <ScrollRevealItem
            className="mx-auto max-w-full md:max-w-[620px]"
            direction="up"
          >
            <p className="font-body mx-auto text-[17px] font-[400] leading-[1.7] text-[#6b7280]">
              Every day, modern practices lose revenue not because of poor care, but
              because of poor capture. The margins of your schedule are bleeding out in
              voicemails, abandoned forms, and unreturned texts.
            </p>
          </ScrollRevealItem>
        </ScrollRevealGroup>
      </div>
        ...
        <div className="w-full">
          <ScrollRevealGroup className="w-full" stagger={0.08}>
            <ScrollRevealItem className="mb-[16px]" direction="up">
              <span className="font-mono-ui text-[12px] font-[500] tracking-[0.12em] uppercase text-[#b5895a]">
                THE MECHANISM
              </span>
            </ScrollRevealItem>
            ...
            <div className="relative">
              ...
              <ScrollRevealGroup
                className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[28px] items-start"
                stagger={0.08}
              >
                {cards.map((c, i) => (
                  <ScrollRevealItem
                    key={i}
                    className="flex flex-col items-start max-[479px]:py-[20px] max-[479px]:px-[16px]"
                    direction="up"
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="font-heading text-[20px] font-[700] text-[#0f0f10] mb-[12px]">
                        {c.title}
                      </div>

                      <div className="font-body text-[14px] font-[400] leading-[1.65] text-[#6b7280]">
                        {c.body}
                      </div>
                    </div>
                  </ScrollRevealItem>
            ...
            <div className="bg-white border border-[#e5e7eb] rounded-[14px] px-[20px] md:px-[22px] lg:px-[24px] py-[24px] md:py-[26px] lg:py-[28px] shadow-[0_2px_20px_rgba(0,0,0,0.05)] max-w-full">
              ...
              <div className="flex flex-col gap-[10px]">
                <div className="flex items-center justify-between border border-[#e5e7eb] rounded-[8px] px-[14px] lg:px-[16px] py-[12px] lg:py-[14px] bg-white">
                  <div className="font-body text-[14px] font-[400] text-[#374151]">
                    Tuesday, 9:00 AM
                  </div>
                  <div className="font-body text-[14px] text-[#9ca3af] line-through">
                    Unavailable
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between border border-[#c9a97a] rounded-[8px] px-[14px] lg:px-[16px] py-[12px] lg:py-[14px] bg-[#fffaf5]">
                  <div className="font-body text-[14px] font-[500] text-[#b5895a]">
                    Tuesday, 10:30 AM
                  </div>
                  <div className="font-body text-[14px] font-[700] text-[#0f0f10]">
                    Auto-Booked
                  </div>
                </div>
          ...
          >
            ...
            <ScrollRevealItem direction="right">
              <p className="font-body text-[17px] font-[400] leading-[1.7] text-[#374151] mb-[28px]">
                Velocity reads your practice management software in real-time, finds the
                exact slot, and books the patient without front-desk intervention.
              </p>
            </ScrollRevealItem>
            ...
            <ScrollRevealItem direction="right" className="flex flex-col gap-[12px]">
              ...
              <div className="flex items-center gap-[12px]">
                <Check className="h-[14px] w-[14px] text-[#b5895a]" />
                <span className="font-body text-[15px] font-[400] text-[#374151]">
                  No double-bookings. Mathematical certainty.
                </span>
              </div>
            </ScrollRevealItem>
          </ScrollRevealGroup>
...
function StatsSection() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={ref}
        className="mx-auto relative max-w-[1440px] px-[24px] md:px-[40px] lg:px-[80px] py-[120px]"
      >
        <ScrollRevealGroup
          className="grid grid-cols-1 md:grid-cols-3 md:divide-x md:divide-[rgba(255,255,255,0.08)]"
          stagger={0.15}
        >
          <ScrollRevealItem
            className="flex flex-col items-start px-0 py-[48px] border-b border-[rgba(255,255,255,0.08)] last:border-b-0 md:py-0 md:border-b-0 md:px-[32px] lg:px-[72px]"
            direction="up"
          >
            <div
              style={{ textShadow: '0 0 80px rgba(201,169,122,0.15)' }}
              className="font-hero text-[clamp(58px,12vw,84px)] md:text-[clamp(56px,7vw,84px)] lg:text-[clamp(64px,8vw,100px)] font-[800] leading-[1] tracking-[-0.03em]"
            >
            ...
            <div className="mt-[24px] mb-[12px]">
              ...
              <div className="font-mono-ui text-[14px] font-[500] tracking-[0.2em] uppercase text-[rgb(245,242,242)]">
                RECOVERY RATE
              </div>
            </div>
...
function TestimonialSection() {
  return (
    <section className="w-full bg-white">
      <ScrollRevealGroup
        className="mx-auto w-full max-w-[860px] px-[24px] md:px-[40px] lg:px-[80px] py-[80px] md:py-[100px] lg:py-[120px] text-center"
        stagger={0.12}
      >
        <ScrollRevealItem
          direction="up"
          className="font-hero text-[clamp(26px,4vw,52px)] font-[500] leading-[1.2] tracking-[-0.02em] text-[#0f0f10] mb-[48px]"
        >
          "Velocity fundamentally changed our unit economics. We thought we had a lead
          volume problem. We actually had a capture problem."
        </ScrollRevealItem>

        <ScrollRevealItem
          direction="up"
          className="mx-auto w-[40px] h-[1px] bg-[#e5e7eb] mb-[32px]"
        />

        <ScrollRevealItem direction="up" className="flex flex-col items-center gap-[6px]">
          <div className="font-body text-[16px] font-[500] text-[#0f0f10]">
            Dr. Sarah Jenkins, MD
          </div>
          <div className="font-mono-ui text-[11px] font-[400] tracking-[0.15em] uppercase text-[#9ca3af]">
            FOUNDER, ADVANCED DERMATOLOGY PARTNERS
          </div>
        </ScrollRevealItem>
      </ScrollRevealGroup>
    </section>
    ...
    <section className="w-full bg-white mlr-auto">
      <div className="mx-auto max-w-[1520px] px-[24px] md:px-[40px] lg:px-[80px] pt-0 pb-[100px]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[24px]">
          <ScrollRevealItem
            className="border border-[#e5e7eb] rounded-[12px] px-[24px] py-[28px] md:p-[28px] lg:p-[40px] min-h-[260px] flex flex-col justify-between max-w-full"
            direction="left"
          >
            <div className="text-[16px] font-body font-[400] leading-[1.75] text-[#374151] mb-[32px]">
              "Most healthcare SaaS feels like a toy. Velocity feels like a clinical
              instrument. It runs quietly in the background, and every Monday I look at a
              dashboard showing tens of thousands in recovered revenue."
            </div>

            <div className="flex flex-col gap-[4px]">
              <div className="font-body text-[15px] font-[500] text-[#0f0f10]">
                Marcus Chen
              </div>
              <div className="font-mono-ui text-[11px] font-[400] tracking-[0.12em] uppercase text-[#9ca3af]">
                DIRECTOR OF OPERATIONS, PACIFIC DENTAL
              </div>
            </div>
          </ScrollRevealItem>
          ...
          >
            <div className="text-[16px] font-body font-[400] leading-[1.75] text-[#374151] mb-[32px]">
              "We were losing patients to competitors simply because they answered the
              phone faster. Velocity leveled the playing field instantly. The AI voice is
              so natural, patients don't even realize they're talking to a system until
              they show up."
            </div>
            ...
            <div className="flex flex-col gap-[4px]">
              ...
              <div className="font-mono-ui text-[11px] font-[400] tracking-[0.12em] uppercase text-[#9ca3af]">
                PRACTICE MANAGER, NY CARDIOLOGY
              </div>
            </div>
          </ScrollRevealItem>
        </div>
...
function FAQAccordionSection() {
  ...
  return (
    ...
    >
      <ScrollRevealGroup
        className="mx-auto w-full max-w-[760px] px-[20px] py-[80px] md:px-[40px] md:py-[100px]"
        stagger={0.08}
      >
  ...
  return (
    <div className="bg-[#0a0a0a] isolate">
      <section className="w-full bg-[#0a0a0a]">
        <ScrollRevealGroup
          className="mx-auto flex max-w-[800px] flex-col items-center gap-[32px] px-[24px] md:px-[40px] lg:px-[80px] py-[100px] text-center"
          stagger={0.12}
        >
          ...
          <ScrollRevealItem direction="up">
            <p className="mx-auto max-w-[560px] font-body text-[16px] md:text-[18px] font-[400] leading-[1.65] text-[rgba(255,255,255,0.45)]">
              Deploy the intelligence that captures every opportunity in the margins of
              your practice.
            </p>
          </ScrollRevealItem>
