...
const SidebarContent = ({ navItems, currentPage, handleNavigation, businessSettings, handleLogout, loggingOut }: SidebarContentProps) => (
  <>
    {/* Logo Section */}
    <motion.div
...
export const Sidebar = ({ onNavigate, isOpen = true, onClose }: Props) => {
